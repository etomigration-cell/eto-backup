...
namespace EtoApi.DataAccess
{
    public class SupportPeriodRepository
    {
       private readonly ISqlConnectionFactory _connectionFactory;
        ...
        public SupportPeriodRepository(ISqlConnectionFactory connectionFactory)
            {
                _connectionFactory = connectionFactory;
            }


        public async Task<List<SupportPeriod>> GetSupportPeriodByIdAsync(int id, int programCode)
        {
