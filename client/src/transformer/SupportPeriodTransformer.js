...
export function mapSupportPeriod(record) {
  return {
    ...
    endDate: record.whatIsTheEndDateOfTheSupportPeriodOnlyCompleteThisWhenTheSupportPeriodHasEnded_16788 ?  moment(record.whatIsTheEndDateOfTheSupportPeriodOnlyCompleteThisWhenTheSupportPeriodHasEnded_16788).format("DD/MM/YYYY") : "",
