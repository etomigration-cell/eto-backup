...
function ServiceAndActivitiesDetailView({ detail }) {
  ...
  return (
    <div className="details-vertical-list">
      ...
      <div>
        ...
        <span className="details-value">
          {detail.participantSpeaksLanguageOtherThanEnglishAtHome}
        </span>
      </div>
      <div>
      ...
      <div>
        ...
        <span className="details-value">
          {detail.receivedServiceFromTeamInPast ?? "Not specified"}
        </span>
      </div>
    </div>
  );
...
export default ServiceAndActivitiesDetailView;
